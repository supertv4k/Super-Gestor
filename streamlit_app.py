...
with tab3:
    ...
    elif filtro_atual == "2dias": df_c = df[df['dias_res'] == import streamlit as st
import pandas as pd
import gspread
from google.oauth2.service_account import Credentials
from datetime import datetime, timedelta
...
def format_data_br(data_str):
    try: 
        # Tenta converter o que vem do Sheets para data e formatar como BR
